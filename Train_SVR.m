function [mdl, Records] = Train_SVR(Input, Target)

setdemorandstream(491218382)
[trnx,trny,valx,valy,tsx,tsy] = Split_data(Input,Target);
epsilon = 0.1; % epsilon parameter
C = 1; % cost parameter
kernel = 'linear'; % kernel type (linear, polynomial, ...
    % radial basis function (RBF), etc.)
mdl = fitrsvm(trnx, trny, 'Epsilon', epsilon, ...
    'BoxConstraint', C, 'KernelFunction', kernel);
